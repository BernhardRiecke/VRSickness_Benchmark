...
Shader "CSRefraction"
{
	Properties
	{
		...
		[ASEEnd][ToggleOff(_CSCAPEMOBILE_OFF)] _CScapeMobile("_CScapeMobile", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local _CSCAPEMOBILE_OFF
			#pragma shader_feature_local _CSCAPEMOBILE_ON
						...
						)
			{
				...
				float3 unpack3 = UnpackNormalScale( tex2D( _TextureSample1, uv_TextureSample1 ), 0.2 );
				unpack3.z = lerp( 1, unpack3.z, saturate(0.2) );
				float3 tex2DNode3 = unpack3;
				
				float4 screenPos = packedInput.ase_texcoord6;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float4 fetchOpaqueVal2 = ASEHDSampleSceneColor(( (ase_screenPosNorm).xy + (( tex2DNode3 * _Float1 )).xy ), 0.0, GetInverseCurrentExposureMultiplier());
				float2 uv_Texture0 = packedInput.ase_texcoord5.xy * _Texture0_ST.xy + _Texture0_ST.zw;
				float4 tex2DNode9 = tex2D( _Texture0, uv_Texture0 );
				#ifdef _CSCAPEMOBILE_OFF
				float4 staticSwitch21 = float4( 0,0,0,0 );
				#else
				float4 staticSwitch21 = ( fetchOpaqueVal2 * ( 1.0 - tex2DNode9.r ) * _Color0 );
				#endif
				
				float4 temp_cast_2 = (0.2).xxxx;
				#ifdef _CSCAPEMOBILE_ON
				...
				surfaceDescription.Normal = tex2DNode3;
				...
				surfaceDescription.Emission = staticSwitch21.rgb;
				surfaceDescription.Smoothness = tex2DNode9.r;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = staticSwitch22.r;
		...
		Pass
		{
					...
					)
			{
				...
				float4 staticSwitch22 = _Color0;
				#else
				float4 staticSwitch22 = temp_cast_0;
				#endif
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_Texture0 = packedInput.ase_texcoord3.xy * _Texture0_ST.xy + _Texture0_ST.zw;
				float4 tex2DNode9 = tex2D( _Texture0, uv_Texture0 );
		...
		Pass
		{
						...
						)
			{
				...
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float4 fetchOpaqueVal2 = ASEHDSampleSceneColor(( (ase_screenPosNorm).xy + (( tex2DNode3 * _Float1 )).xy ), 0.0, GetInverseCurrentExposureMultiplier());
				float2 uv_Texture0 = packedInput.ase_texcoord7.xy * _Texture0_ST.xy + _Texture0_ST.zw;
				float4 tex2DNode9 = tex2D( _Texture0, uv_Texture0 );
				#ifdef _CSCAPEMOBILE_OFF
				float4 staticSwitch21 = float4( 0,0,0,0 );
				#else
...
/*ASEBEGIN
Version=18900
1160;145;1901;1154;1254.709;570.0554;1.536271;True;True
Node;AmplifyShaderEditor.SamplerNode;3;-1530.815,66.50577;Inherit;True;Property;_TextureSample1;Texture Sample 1;1;0;Create;True;0;0;0;False;0;False;-1;None;77f5feff8fd410d4e85cb24c60731d33;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;0.2;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;4;-1458.279,300.619;Float;False;Property;_Float1;Float 1;0;0;Create;True;0;0;0;False;0;False;0.292;0.032;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;5;-1149.978,161.0194;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
WireConnection;36;6;25;0
WireConnection;36;7;26;0
WireConnection;36;9;27;0
ASEEND*/
//CHKSM=278618C3663DCA284D0354CC591220F43ADD88AC